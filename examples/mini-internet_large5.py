...
#Makers.makeTransitAs(base, 8, [105, 101], [(105, 101)], proxy[7])
...
ebgp.addRsPeers(105, [ 4, 5])#removed 8
ebgp.addRsPeers(106, [51, 2]) #removed 9
ebgp.addRsPeers(107, [39, 40, 31])
ebgp.addRsPeers(108, [32, 33])
ebgp.addRsPeers(109, [31, 32, 38])#removed 41
ebgp.addRsPeers(110, [33, 34])
ebgp.addRsPeers(111, [38, 34, 35])
ebgp.addRsPeers(112, [35])#removed 36, 37
ebgp.addRsPeers(113, [40])#removed 11
ebgp.addRsPeers(114, [7])#removed 14, 15
ebgp.addRsPeers(115, [6, 7])
ebgp.addRsPeers(116, [15, 16])
ebgp.addRsPeers(117, [ 14, 11,  13]) #removed 10, 12
ebgp.addRsPeers(118, [16])#removed 18
ebgp.addRsPeers(119, [13])#removed 30
ebgp.addRsPeers(120, [ 19])#removed 18
ebgp.addRsPeers(121, [ 19])#removed 20
ebgp.addRsPeers(122, [28, 29])
ebgp.addRsPeers(123, [41, 36, 27, 28])#removed 12
ebgp.addRsPeers(124, [27])#removed 26
ebgp.addRsPeers(125, [ 20])#removed 21
ebgp.addRsPeers(126, [ 25, 26, 21])#removed 22
ebgp.addRsPeers(127, [24, 37, 25])
ebgp.addRsPeers(128, [ 24])# removed 28
...
ebgp.addPrivatePeerings(101, [51],  [150], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(101, [39],  [150], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(102, [2],  [151], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(102, [3],  [151], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(103, [3],  [152], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(103, [4],  [152], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(104, [5],  [153], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(104, [6],  [153], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(105, [4],  [154], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(105, [5],  [154], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(105, [8],  [154], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(106, [51],  [155], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(106, [2],  [155], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(106, [9],  [155], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(107, [31],  [156], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(107, [39],  [156], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(107, [40],  [156], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(108, [33],  [157], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(108, [32],  [157], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(109, [31],  [158], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(109, [32],  [158], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(109, [38],  [158], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(109, [41],  [158], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(110, [33],  [159], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(110, [34],  [159], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(111, [34],  [160], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(111, [38],  [160], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(111, [35],  [160], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(112, [35],  [161], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(112, [36],  [161], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(112, [37],  [161], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(113, [40],  [162], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(113, [11],  [162], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(114, [7],  [163], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(114, [14],  [163], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(114, [15],  [163], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(115, [6],  [164], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(115, [7],  [164], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(116, [15],  [165], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(116, [16],  [165], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(117, [11],  [166], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(117, [12],  [166], PeerRelationship.Provider)
...
#ebgp.addPrivatePeerings(118, [16],  [167], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(118, [17],  [167], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(119, [13],  [168], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(119, [30],  [168], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(120, [18],  [169], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(120, [19],  [169], PeerRelationship.Provider)
...
#ebgp.addPrivatePeerings(121, [20],  [170], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(122, [28],  [171], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(122, [29],  [171], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(123, [41],  [172], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(123, [36],  [172], PeerRelationship.Provider)
...
#ebgp.addPrivatePeerings(124, [26],  [173], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(124, [27],  [173], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(125, [20],  [174], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(125, [21],  [174], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(126, [21],  [175], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(126, [22],  [175], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(126, [25],  [175], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(126, [26],  [175], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(127, [24],  [176], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(127, [25],  [176], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(127, [37],  [176], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(128, [23],  [177], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(128, [24],  [177], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(129, [22],  [178], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(129, [23],  [178], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(130, [17],  [179], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(130, [18],  [179], PeerRelationship.Provider)

#ebgp.addPrivatePeerings(131, [8],  [180], PeerRelationship.Provider)
#ebgp.addPrivatePeerings(131, [9],  [180], PeerRelationship.Provider)
...
emu.render()
emu.compile(Docker(), './output_large2', override=True)
