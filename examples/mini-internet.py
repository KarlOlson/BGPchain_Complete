...
Makers.makeTransitAs(base, 2, [100, 101, 102, 105], 
       [(100, 101), (101, 102), (100, 105)], proxy[0]
)

Makers.makeTransitAs(base, 3, [100, 103, 104, 105], 
       [(100, 103), (100, 105), (103, 105), (103, 104)], proxy[1]
)

Makers.makeTransitAs(base, 4, [100, 102, 104], 
       [(100, 104), (102, 104)], proxy[2]
)

## Tier 2 ASes
Makers.makeTransitAs(base, 11, [102, 105], [(102, 105)], proxy[3])
Makers.makeTransitAs(base, 12, [101, 104], [(101, 104)], proxy[4])


###############################################################################
# Create single-homed stub ASes. "None" means create a host only 

Makers.makeStubAs(emu, base, 150, 100, [web, None], proxy[5])
Makers.makeStubAs(emu, base, 151, 100, [web, None], proxy[6])

Makers.makeStubAs(emu, base, 152, 101, [None, None], proxy[7])
Makers.makeStubAs(emu, base, 153, 101, [web, None, None], proxy[8])

Makers.makeStubAs(emu, base, 154, 102, [None, web], proxy[9])

Makers.makeStubAs(emu, base, 160, 103, [web, None], proxy[10])
Makers.makeStubAs(emu, base, 161, 103, [web, None], proxy[11])
Makers.makeStubAs(emu, base, 162, 103, [web, None], proxy[12])

Makers.makeStubAs(emu, base, 163, 104, [web, None], proxy[13])
Makers.makeStubAs(emu, base, 164, 104, [None, None], proxy[14])

Makers.makeStubAs(emu, base, 170, 105, [web, None], proxy[15])
Makers.makeStubAs(emu, base, 171, 105, [None], proxy[16])
